...
yourArray debe contener al menos uno boolean.
yourArray debe contener al menos uno number.
yourArray debe contener al menos uno string.*/

let yourArray = ["a", 2, true, "c", null, { name: "leticia" }];
