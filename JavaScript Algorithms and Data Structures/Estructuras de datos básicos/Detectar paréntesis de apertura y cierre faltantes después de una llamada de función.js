...
Corrija el código para que la variable result se establezca en el valor devuelto al llamar a la función getNine.*/
//Ejercicio
/* Su código debe corregir la variable resultpara que se establezca en el número que getNine devuelve la función.
Su código debe llamar a la getNine función.*/
function getNine() {
  let x = 6;
  let y = 3;
  return x + y;
